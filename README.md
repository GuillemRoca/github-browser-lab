...
<img align="right" src="https://github.com/GuillemRoca/github-browser-lab/blob/main/assets/demo.gif" alt="A demo illustrating the UI of the app" width="320" height="676" style="display: inline; float: right"/>
